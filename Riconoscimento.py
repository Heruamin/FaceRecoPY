...
while True:
    ...
    if process_this_frame:
        ...
        if(len(face_encodings) != 0):
            if (face_encodings[0].shape[0] == 128):
                ...
                simile = k_means.predict([[Valore0, Valore1,Valore2,Valore3, Valore4,Valore5,Valore6,Valore7,Valore8,Valore9, Valore10,Valore11,
                                 Valore12, Valore13,Valore14,Valore15, Valore16,Valore17,Valore18, Valore19,Valore20,Valore21,
                                 Valore22,Valore23,Valore24,Valore25,Valore26,Valore27, Valore28,Valore29,
                                 Valore30, Valore31,Valore32,Valore33, Valore34,Valore35,
                                 Valore36, Valore37,Valore38, Valore39, Valore40, Valore41, Valore42, Valore43, Valore44, Valore45,
                ...
                #simile restituisce un array di dim 1 enumaretor
                #obj1 = enumerate(Cluster)
                pred_esempio = "sono vuoto"
                for count,element in enumerate(Cluster):
                    if simile[0] == count:
                        pred_esempio = element

                pred_esempio = "Clsuter dei simili:," + str(pred_esempio)
                pred_esempio = pred_esempio.split(',')
                print(*pred_esempio)
                pred_esempio = list(reversed(pred_esempio))

                print("Predizione fatta dal classificatore: ", y_pred[0])
                print("Probabilità di appartenenza alle classi (logaritmica): ", p)
                if ((y_pred[0] == 1) and (np.any(p == 1))):#bisogna mettere np.any perchè quando si ha un vettore con molti valori
                    ...
                    name = "Aaron Judge"
                elif ((y_pred[0] == 2) and (np.any(p == 1))):
                    name = "Aaron Paul"
                elif ((y_pred[0] == 3) and (np.any(p == 1))):
                    name = "Aaron Taylor-Johnson"
                elif ((y_pred[0] == 4) and (np.any(p == 1))):
                    name = "Abigail Breslin"
                elif ((y_pred[0] == 5) and (np.any(p == 1))):
                    name = "Adam Sandler"
                elif ((y_pred[0] == 6) and (np.any(p == 1))):
                    name = "Alan Rickman"
                elif ((y_pred[0] == 7) and (np.any(p == 1))):
                    name = "Alexandra Daddario"
                elif ((y_pred[0] == 8) and (np.any(p == 1))):
                    name = "Andy Garcia"
                elif ((y_pred[0] == 9) and (np.any(p == 1))):
                    name = "Anthony Hopkins"
                elif ((y_pred[0] == 10) and (np.any(p == 1))):
                    name = "Benedict Cumberbatch"
                elif ((y_pred[0] == 11) and (np.any(p == 1))):
                    name = "Al Pacino"
                elif ((y_pred[0] == 12) and (np.any(p == 1))):
                    name = "Bradley Cooper"
                elif ((y_pred[0] == 13) and (np.any(p == 1))):
                    name = "Bruce Willis"
                elif ((y_pred[0] == 14) and (np.any(p == 1))):
                    name = "George Clooney"
                elif ((y_pred[0] == 15) and (np.any(p == 1))):
                    name = "Harrison Ford"
                elif ((y_pred[0] == 16) and (np.any(p == 1))):
                    name = "Jennifer Aniston"
                elif ((y_pred[0] == 17) and (np.any(p == 1))):
                    name = "Jennifer Lawrence"
                elif ((y_pred[0] == 18) and (np.any(p == 1))):
                    name = "Jim Carrey"
                elif ((y_pred[0] == 19) and (np.any(p == 1))):
                    name = "Richard Gere"
                elif ((y_pred[0] == 20) and (np.any(p == 1))):
                    name = "Samuel L.Jackson"
                elif ((y_pred[0] == 21) and (np.any(p == 1))):
                    name = "Woody Allen"
                elif ((y_pred[0] == 22) and (np.any(p == 1))):
                    name = "Cobie Smulders"
                elif ((y_pred[0] == 23) and (np.any(p == 1))):
                    name = "Jeremy Renner"
                elif ((y_pred[0] == 24) and (np.any(p == 1))):
                    name = "Angelina Jolie"
                elif ((y_pred[0] == 25) and (np.any(p == 1))):
                    name = "Daniel Radcliffe"
                elif ((y_pred[0] == 26) and (np.any(p == 1))):
                    name = "Emma Watson"
                elif ((y_pred[0] == 27) and (np.any(p == 1))):
                    name = "Johnny Depp"
                elif ((y_pred[0] == 28) and (np.any(p == 1))):
                    name = "Keanu Reeves"
                elif ((y_pred[0] == 29) and (np.any(p == 1))):
                    name = "Megan Fox"
                elif ((y_pred[0] == 30) and (np.any(p == 1))):
                    name = "Nicole Kidman"
                elif ((y_pred[0] == 31) and (np.any(p == 1))):
                    name = "Orlando Bloom"
                elif ((y_pred[0] == 32) and (np.any(p == 1))):
                    name = "Tom Hiddleston"
                elif ((y_pred[0] == 33) and (np.any(p == 1))):
                    name = "Matthew McConaughey"
                elif ((y_pred[0] == 34) and (np.any(p == 1))):
                    name = "Meryl Streep"
                elif ((y_pred[0] == 35) and (np.any(p == 1))):
                    name = "Micheal Keaton"
                elif ((y_pred[0] == 36) and (np.any(p == 1))):
                    name = "Robert Redford"
                elif ((y_pred[0] == 37) and (np.any(p == 1))):
                    name = "Scarlett Johansson"
                elif ((y_pred[0] == 39) and (np.any(p == 1))):
                    name = "Chad Smith"
                elif ((y_pred[0] == 40) and (np.any(p == 1))):
                    name = "Will Ferrel"
                elif ((y_pred[0] == 41) and (np.any(p == 1))):
                    name = "Katy Perry"
                elif ((y_pred[0] == 42) and (np.any(p == 1))):
                    name = "Zooey Deschanel"
                elif ((y_pred[0] == 43) and (np.any(p == 1))):
                    name = "Jeffrey Dean Morgan"
                elif ((y_pred[0] == 44) and (np.any(p == 1))):
                    name = "Javier Bardem"
                elif ((y_pred[0] == 45) and (np.any(p == 1))):
                    name = "Matt Bomer"
                elif ((y_pred[0] == 46) and (np.any(p == 1))):
                    name = "Henry Cavill"
                elif ((y_pred[0] == 47) and (np.any(p == 1))):
                    name = "Logan Marshall-Green"
                elif ((y_pred[0] == 48) and (np.any(p == 1))):
                    name = "Tom Hardy"
                elif ((y_pred[0] == 49) and (np.any(p == 1))):
                    name = "Isla Fisher"
                elif ((y_pred[0] == 50) and (np.any(p == 1))):
                    name = "Amy Adams"
                elif ((y_pred[0] == 51) and (np.any(p == 1))):
                    name = "Mila Kunis"
                elif ((y_pred[0] == 52) and (np.any(p == 1))):
                    name = "Sarah Hyland"
                elif ((y_pred[0] == 53) and (np.any(p == 1))):
                    name = "Nicola Nargiso"
                elif ((y_pred[0] == 54) and (np.any(p == 1))):
                    name = "Michele Metta"
                elif ((y_pred[0] == 55) and (np.any(p == 1))):
                    name = "Matteo Mariano"
                else:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        nome = ''.join(nome)
        print(nome)
        if (nome != "Sconosciuto" and nome!= "Michele Metta" and nome != "Matteo Mariano" and nome != "Nicola Nargiso"):
            attore = nome
            ...
            cv2.putText(frame, name, (left, bottom - 20), font, font_scale, color, thickness)
            h, w, c = frame.shape
            left = 1
            bottom = h - 5
            j = 20
            for element in pred_esempio:
                size = cv2.getTextSize(element, font, font_scale, thickness)
                text_width = size[0][0]
                text_height = size[0][1]
                cv2.rectangle(frame, (left, bottom - j - 20), (text_width + 10, bottom - j), (128, 255, 128), cv2.FILLED)
                cv2.putText(frame, element, (left, bottom - j), font, font_scale, color, thickness)
                j = j + 20
            ...
            cv2.putText(frame, name, (left, bottom - 20), font, font_scale, color, thickness)
            #size = cv2.getTextSize(pred_esempio, font, font_scale, thickness)
            h, w, c = frame.shape
            left = 1
            bottom = h - 5
            j = 0
            for element in pred_esempio:
                ...
                text_width = size[0][0]
                text_height = size[0][1]
                cv2.rectangle(frame, (left, bottom - j - 20), (text_width + 10, bottom - j), (0, 0, 255), cv2.FILLED)
                cv2.putText(frame, element, (left, bottom - j), font, font_scale, color, thickness)
                j = j + 20
